...
const hasCheckedOnOrganisationConfiguration = () => {
    ...
    cy.contains('p', ':').should("exist");
    cy.contains('p', 'An Organisation is not on the UK sanctions list.').should("exist");
    cy.get('#17').should("exist").uncheck();
    cy.contains('p', "Data security compliance:").should("exist");
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has Cyber Essentials certification.").should("exist");
    cy.get('#18').should("exist").uncheck();
    cy.contains('p', "Data security compliance:").should("exist");
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has Cyber Essentials Plus certification.").should("exist");
    cy.get('#19').should("exist").uncheck();
    cy.contains('p', "Data security compliance:").should("exist");
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has ISO27001 Accredited certification.").should("exist");
    cy.get('#20').should("exist").uncheck();
    cy.contains('p', "Data security compliance:").should("exist");
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has either a Cyber Essentials or ISO27001 Accredited certification.").should("exist");
    cy.get('#21').should("exist").uncheck();
    cy.contains('p', "Data security compliance:").should("exist");
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has either a Cyber Essentials Plus or ISO27001 Accredited certification.").should("exist");
    ...
    cy.contains('p', ':').should("exist");
    cy.contains('p', "An Organisation has at least one Delegate/Key Contact to affiliate Users.").should("exist");
    cy.saveContinueClick("Save");
    cy.swalClick("Close");
};
