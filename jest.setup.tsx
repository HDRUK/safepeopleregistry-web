...
async function mockFetch(url: string, init?: RequestInit) {
  ...
  switch (baseUrl) {
    ...
    case `${process.env.NEXT_PUBLIC_API_V1_URL}/organisations/unclaimed_before_superadmin_invitation`: {
      return mock200Json(1);
    }
    ...
    case `${process.env.NEXT_PUBLIC_API_V1_URL}/organisations/1/invite_to_contact_superadmin`: {
      return mock200Json(1);
    }
