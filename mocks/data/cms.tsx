...
export const mockedBannerContent = () => (
  <>
    ...
    functionality during our initial preview phase: - Please be aware that some
    pages/features aren't fully available. Live system launched for public
    testing! Please note, any accounts made previously on our Beta preview have
    been removed. Please do get in touch if you notice any issues or would like
    to try out our system: <ContactLink />.
  </>
);
