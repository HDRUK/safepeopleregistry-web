export const safePeopleRegistryConsumerTermsSection1 = `
...
`;
export const safePeopleRegistryConsumerTermsSection2 = `
...
`;
export const safePeopleRegistryConsumerTermsSection4 = `
# 4. ACCEPTABLE USE
...
### 4.1.2 copy, modify or otherwise reproduce or re-sell any part of the Safe People Registry;
or
...
export const safePeopleRegistryConsumerTermsSection7 = `
# 7. OUR LIABILITY
...
export const safePeopleRegistryConsumerTermsSection8 = `
...
export const safePeopleRegistryConsumerTermsSection9 = `
...
### 9.1.3 we are required by law or regulation to do so. We will not be liable to you for the unavailability of the Safe People Registry during such suspension.

## 9.2 If you breach any of these Terms, we may immediately do any or all of the following:

### 9.2.1 issue a warning to you;

### 9.2.2 temporarily or permanently remove any Input Data uploaded by you to the Safe People Registry;

### 9.2.3 temporarily or permanently withdraw your right to use the Safe People Registry;
...
`;
export const safePeopleRegistryConsumerTermsSection10 = `
...
export const safePeopleRegistryConsumerTermsSection11 = `
...
export const safePeopleRegistryConsumerTermsSection12 = `
...
export const safePeopleRegistryConsumerTermsSection13 = `
...
export const safePeopleRegistryConsumerTermsSection14 = `
# 14. CONTACTING US
...
## 14.3 You can contact us by clicking [here](mailto:enquiries@safepeopleregistry.org) or by using the following details:
