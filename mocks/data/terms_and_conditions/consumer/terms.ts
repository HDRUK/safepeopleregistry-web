...
export const safePeopleRegistryConsumerTermsSection3 = `# 3. YOUR ACCOUNT AND PASSWORD
...
export const safePeopleRegistryConsumerTermsSection4 = `# 4. ACCEPTABLE USE
...
`;
export const safePeopleRegistryConsumerTermsSection5 = `# 5. INTELLECTUAL PROPERTY
...
`;
export const safePeopleRegistryConsumerTermsSection6 = `# 6. INPUT DATA
...
`;
export const safePeopleRegistryConsumerTermsSection9 = `# 9. SUSPENSION AND TERMINATION
...
`;
export const safePeopleRegistryConsumerTermsSection10 = `# 10. CHANGES TO THESE TERMS
...
`;
export const safePeopleRegistryConsumerTermsSection11 = `# 11. THIRD PARTY CONTENT
...
`;
export const safePeopleRegistryConsumerTermsSection12 = `# 12. OTHER IMPORTANT INFORMATION
...
`;
export const safePeopleRegistryConsumerTermsSection13 = `# 13. GOVERNING LAW AND JURISDICTION
...
`;
export const safePeopleRegistryConsumerTermsSection14 = `# 14. CONTACTING US
