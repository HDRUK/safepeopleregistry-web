...
export const mockedTermsAndConditionsBusiness = {
  ...
  account: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection5}</Markdown>
    ),
  },
  acceptableUse: {
    content: (
  ...
  inputData: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection8}</Markdown>
    ),
  },
  liability: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection9}</Markdown>
    ),
  },
  disclaimers: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection10}</Markdown>
    ),
  },
  suspension: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection11}</Markdown>
    ),
  },
  changes: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection12}</Markdown>
    ),
  },
  thirdParty: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection13}</Markdown>
    ),
  },
  other: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection14}</Markdown>
    ),
  },
  law: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection15}</Markdown>
    ),
  },
  contact: {
    content: (
      <Markdown variant="legal">{safePeopleRegistryTermsSection16}</Markdown>
    ),
  },
};
