...
ARG NEXT_PUBLIC_KEYCLOAK_REDIRECT_URL_LINK
ARG NEXT_PUBLIC_KEYCLOAK_GATEWAY_CLIENT_ID
ARG NEXT_PUBLIC_KEYCLOAK_GATEWAY_REDIRECT_URL_LOGIN
ARG NEXT_PUBLIC_KEYCLOAK_GATEWAY_REDIRECT_URL_REGISTER
